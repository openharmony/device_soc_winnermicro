...
typedef  struct _HOSTIF_CMD_PARAMS_BTPARAM_BLESND {
    u8    param[128];
    uint16_t param_len;
    enum    tls_cmd_mode cmd_mode;
}__attribute__((packed))HOSTIF_CMD_PARAMS_BTPARAM_BLESND;
...
typedef struct _HOSTIF_CMD_PARAMS_TOKEN {
    uint8_t len;
    uint8_t token[TOKEN_LEN];
}__attribute__((packed))HOSTIF_CMD_PARAMS_TOKEN;
...
union HOSTIF_CMD_PARAMS_UNION {
    ...
    HOSTIF_CMD_PARAMS_BTPARAM_BLESND blesnd;

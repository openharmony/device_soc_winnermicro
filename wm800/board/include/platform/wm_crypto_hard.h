 ...
 *                writing the Message-Digest in the 20-byte buffer pointed to by hash in according to
 *                the information stored in context.
 *
 * @param[in]        md        Pointer to the SHA1 Digest Context.
 ...
 *      MD5 is the algorithm which takes as input a message of arbitrary length
